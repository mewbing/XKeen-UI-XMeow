...
- [ ] 20-02-PLAN.md -- Agent binary + setup.sh --agent (SSH client, auto-reconnect, heartbeat, init.d)
- [ ] 20-03-PLAN.md -- Remote API handlers + HTTP proxy + server integration (/api/remote/*, WS status)
- [ ] 20-04-PLAN.md -- Frontend remote page + store + API (agent cards, empty state, token manager)
- [ ] 20-05-PLAN.md -- Frontend context switching + settings (API interceptor, ContextSwitcher, routing)
...
| 20. Remote Management | v3.0 | 0/5 | Not started | - |
