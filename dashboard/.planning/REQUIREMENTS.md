...
- [x] **SUPD-03**: Backend restarts gracefully after self-update via init.d
...
- [x] **SUPD-06**: In external-ui mode: backend downloads and extracts dist.tar.gz into mihomo external-ui directory
